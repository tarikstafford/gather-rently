...
const ChatLog: React.FC<ChatLogProps> = () => {
    ...
    return (
        <div className='absolute top-0 left-0 hidden sm:flex'>
            {!expanded && (
                <div
                    className='bg-plum hover:bg-dark-plum text-white animate-colors p-2 grid place-items-center rounded-br-lg cursor-pointer border-r border-b border-dark-plum'
                    onClick={expand}
                >
            ...
            {expanded && (
                <div className='bg-plum bg-opacity-95 w-[500px] h-[200px] rounded-br-lg transparent-scrollbar relative p-1 border-r border-b border-dark-plum'>
                    <div className='cursor-pointer absolute bottom-0 right-0 rounded-tl-lg rounded-br-lg bg-dark-plum hover:bg-plum-stain hover:text-dark-plum text-white animate-colors p-2' onClick={collapse}>
